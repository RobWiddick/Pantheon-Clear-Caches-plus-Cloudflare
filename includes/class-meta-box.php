...
class Meta_Box {
	...
	public function add_meta_box( $post_type ) {
		...
		add_meta_box(
			'cpcf-purge-control',
			__( 'Cache Purge Control', 'purge-pantheon-cloudflare-caches' ),
			array( $this, 'render' ),
			$post_type,
			'side',
			'low'
	...
	public function render( $post ) {
		...
		?>
		<p>
			<label for="cpcf-purge-mode"><strong><?php esc_html_e( 'When this is saved', 'purge-pantheon-cloudflare-caches' ); ?></strong></label><br />
			<select name="cpcf_purge_mode" id="cpcf-purge-mode" class="widefat">
				...
				<?php
					...
					echo esc_html( sprintf( __( 'Use post type setting (%s)', 'purge-pantheon-cloudflare-caches' ), isset( $labels[ $type_mode ] ) ? $labels[ $type_mode ] : $type_mode ) );
				?>
				</option>
		...
		<p>
			<label for="cpcf-extra-urls"><strong><?php esc_html_e( 'Also purge these URLs', 'purge-pantheon-cloudflare-caches' ); ?></strong></label><br />
			...
			<span class="description"><?php esc_html_e( 'One per line. Paths are relative to the site. End a path with * to purge everything under it.', 'purge-pantheon-cloudflare-caches' ); ?></span>
		</p>
		<p>
			<strong><?php esc_html_e( 'Purge this when any of these change', 'purge-pantheon-cloudflare-caches' ); ?></strong><br />
			...
			<?php endforeach; ?>
			<span class="description"><?php esc_html_e( 'Use this for pages that list or embed other content, such as a team page built from "People" entries.', 'purge-pantheon-cloudflare-caches' ); ?></span>
		</p>
		<?php
	}
