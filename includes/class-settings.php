	...
	public function sanitize( $input ) {
		...
		if ( ! $this->zone_from_constant() && isset( $input['zone'] ) ) {
			...
			if ( '' === $zone ) {
				...
				add_settings_error( self::OPTION, 'cpcf_zone', __( 'The selected zone is not valid. Please verify your token and choose a zone again.', 'cache-purge-control-for-cloudflare' ) );
			}
		}
